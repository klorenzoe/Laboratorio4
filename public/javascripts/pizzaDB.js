...
$(document).ready(function(){
    ...
    $('#btn_CreatePizza').click(function(){
        ...
        makeRequest('POST', 'pizzaDB/Create', pizza, function(data) { showMessage(data); } );
    });
    ...
    $(document).on('click', 'button', function(event) {
        if (this.id === "btn_DeletePizza"){
             ...
             makeRequest('DELETE', 'pizzaDB/Delete', { name : pizzaName }, function(data) { location.reload(); } );
        }
      });
      ...
      $('#btn_UpdatePizza').click(function(){
        ...
        makeRequest('PUT', 'pizzaDB/Update', pizza, function(data) { showMessage(data); } );        
      });
    ...
    $('#btn_SearchPizza').click(function(){
        ...
        makeRequest('GET', 'pizzaDB/Search', { name : pizzaName }, function(data) { loadPizzas(data.results) });
    });
});
